...
public class BlogController {
	...
	private String genUpAndDownPageCode(Blog lastBlog,Blog nextBlog,String projectContext){
		...
		if(lastBlog==null || lastBlog.getId()==null){
			pageCode.append("<p class=\"last\">上一篇：没有了</p>");
		}else{
			pageCode.append("<p class=\"last\">上一篇：<a href='"+projectContext+"/blog/articles/"+lastBlog.getId()+".html'>"+lastBlog.getTitle()+"</a></p>");
		}
		if(nextBlog==null || nextBlog.getId()==null){
			pageCode.append("<p class=\"next\">下一篇：没有了</p>");
		}else{
			pageCode.append("<p class=\"next\">下一篇：<a href='"+projectContext+"/blog/articles/"+nextBlog.getId()+".html'>"+nextBlog.getTitle()+"</a></p>");
		}
