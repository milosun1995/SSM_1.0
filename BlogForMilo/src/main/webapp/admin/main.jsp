	...
	<div class="table-responsive">
		...
		<table class="table table-striped table-hover">
			<tbody>
				<tr>
					<td>
						<span style="display: inline-block; width: 8em">版权所有</span>
						POWERED BY WY ALL RIGHTS RESERVED  
					</td>
				</tr>
				<!-- <tr>
					<td>
						<span style="display: inline-block; width: 10em">Copyright&copy; 2017-2018 www.wfyvv.com <a href="#"
							target="_blank">皖ICP备17002922号</a><br>
						</span>
					</td>
				</tr> -->
			</tbody>
